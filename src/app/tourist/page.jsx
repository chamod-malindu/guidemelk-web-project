  ...
  const guides = [
    {
      ...
      reviews: 127,
      price: 45,
      image: "https://via.placeholder.com/300x300/a3e635/1e40af?text=Kasun+Perera",
    ...
    },
    {
      ...
      reviews: 89,
      price: 40,
      image: "https://via.placeholder.com/300x300/fde047/a21caf?text=Nimal+Silva",
    ...
    },
    {
      ...
      reviews: 156,
      price: 50,
      image: "https://via.placeholder.com/300x300/fca5a5/be123c?text=Priya+Fernando",
    ...
    },
    {
      ...
      reviews: 73,
      price: 42,
      image: "https://via.placeholder.com/300x300/bfdbfe/1d4ed8?text=Rajesh+Kumar",
    ...
    },
    {
      ...
      reviews: 134,
      price: 48,
      image: "https://via.placeholder.com/300x300/d8b4fe/7e22ce?text=Chaminda+W",
    ...
    },
    {
      ...
      reviews: 67,
      price: 38,
      image: "https://via.placeholder.com/300x300/a78bfa/4c0519?text=Amara+J",
    ...
    <div className={`${isDarkMode ? 'dark' : ''} min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-50 font-sans`}>
      <header className="sticky top-0 z-50 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-sm py-4 px-6 md:px-12 flex justify-between items-center rounded-b-xl">
        ...
        <nav className="hidden md:flex space-x-6">
          ...
          <Link href="/findGuide" className="text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors duration-300">Find a Guide</Link>
          ...
          <Link href="/tourist/dashboardpage/dashboardpage" className="text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors duration-300">Dashboard</Link>
        </nav>
