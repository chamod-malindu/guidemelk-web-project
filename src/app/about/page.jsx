...
import { Sun, Moon, Link as LucideLink } from 'lucide-react'; // Importing icons, using Link as LucideLink to avoid conflict with Next.js Link
// import Link from 'next/link'; // Import Link component for client-side navigation - REMOVED
